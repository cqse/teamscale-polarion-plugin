...
public class WorkItemUpdatesCollector {
  ...
  //  /**
  //   * Helper method that will collect field changes (to be included in a WorkItemChange object)
  // based
  ...
  //   * Rather then having a 'before value' replaced by an 'after value' Polarion returns these
  // fields
  ...
  //      fieldChanges.addAll(
  //          collectFieldDiffAsCollection(added, workItemId, workItemChangeRevision, fieldDiff,
  // true));
  //    }
  ...
  //  /**
  //   * This is an overload of the helper {@see #collectFieldDiffAsCollection(String,
  // WorkItemChange, IFieldDiff)
  //   * that applies to either added or removed items from fields that are treated as collections
  // in Polarion
  //   * Note: for custom fields, Polarion API behaves differently. The returned collection is not
  // convertible to
  //   * a list of IPObjects. The collection comes as untyped List (ArrayList) and typically the
  // internal elements are
  //   * of type EnumOption (as custom field types are typically defined as enumerations on Polarion
  // admin settings).
  //   * */
  //  private List<WorkItemFieldDiff> collectFieldDiffAsCollection(
  ...
  //      // For custom fields Polarion returns an untyped List (ArrayList) and typically the
  // internal
  //      // elements are of type EnumOption (as custom field types are typically defined as
  //      // enumerations on Polarion admin settings).
  //      WorkItemFieldDiff fieldChange = new WorkItemFieldDiff(fieldDiff.getFieldName());
  //      if (isAdded) {
  //        fieldChange.setElementsAdded(CastUtils.castUntypedListToStrList((List<?>)
  // addedOrRemovedItems));
  //      } else {
  ...
  //  /**
  //   * Helper method for {@link #collectFieldDiffAsCollection(Collection, String, String,
  // IFieldDiff,
  //   * boolean)}. This method first checks if there's a match between the linkRole and list of all
  //   * link roles expected by the request. If yes, it creates the link field diff and calls the
  // {@link
  //   * #updateOppositeLinksMap(String, String, ILinkedWorkItemStruct, boolean)}. It returns null
  // if
  ...
  //      WorkItemFieldDiff fieldChange =
  //          new LinkFieldDiff(
  //              fieldDiff.getFieldName(), linkRole.getId(), linkRole.getName(),
  // LinkDirection.OUT);
  ...
  //   * @param link that represent a ILinkWorkItemStruct given by Polarion containing the
  // added/removed
  //   *     link
  ...
  //  /**
  //   * Helper method called by {@link #updateOppositeLinksMap()} to check if a LinkBundle was
  // already
  //   * created in the map *
  //   */
  ...
  //   */
  //  public void createLinkChangesOppositeEntries(final Map<String, WorkItemForJson>
  // allItemsToSend) {
  ...
  //            linkBundles.forEach(
  //                linkBundle -> {
  //                  WorkItemChange workItemChange = findRevisionEntry(workItemChanges,
  // linkBundle);
