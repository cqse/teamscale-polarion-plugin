...
/**
 * This servlet was created for debugging purposes. It prints out in the console document info.
 *
...
public class DocumentsServlet extends HttpServlet {
  ...
  protected void doGet(final HttpServletRequest req, final HttpServletResponse resp)
    ...
    for (IModule module : modules) {
      System.out.println(
          "Module ID: "
              + module.getId()
              + " \n Location path: "
              + module.getModuleLocation().getLocationPath() // <folder>/<docId>
              + " \n KEY_LOCATION: "
              + module.getValue(IModule.KEY_LOCATION) // Full Location obj
              + " \n KEY_TITLE: "
              + module.getValue(IModule.KEY_TITLE)
              + " \n KEY_MODULEFOLDER: "
              + module.getValue(IModule.KEY_MODULEFOLDER) // <folder>
              + " \n KEY_MODULELOCATION: "
              + module.getValue(IModule.KEY_MODULELOCATION)); // simple location obj
    }
    ...
    //        getServletContext().getRequestDispatcher("/currentUserWorkload.jsp").forward(req,
    // resp);
  }
